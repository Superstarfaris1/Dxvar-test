...
MOCK_GENETIC_DISORDERS = [
    ...
    },
    {
        ...
        "hpo": ["HP:0001994 (Neonatal vomiting)", "HP:0001249 (Intellectual disability)", "HP:0000739 (Seizures)"],
        "inheritance": "Autosomal Recessive",
        "genes": ["PAH"]
    },
    {
        "name": "Tay-Sachs Disease",
        "hpo": ["HP:0001250 (Severe muscular hypotonia)", "HP:0001260 (Cherry red spot)", "HP:0001276 (Neurodegeneration)"],
        "inheritance": "Autosomal Recessive",
        "genes": ["HEXA"]
    },
    {
        "name": "Neurofibromatosis Type 1",
        "hpo": ["HP:0009733 (Cafe-au-lait spots)", "HP:0001661 (Neurofibromas)", "HP:0000486 (Lisch nodules)"],
        "inheritance": "Autosomal Dominant",
        "genes": ["NF1"]
    },
    {
        "name": "Hemophilia A",
        "hpo": ["HP:0001928 (Prolonged bleeding)", "HP:0001981 (Hemarthrosis)", "HP:0003010 (Factor VIII deficiency)"],
        "inheritance": "X-linked",
        "genes": ["F8"]
    },
    {
        "name": "Alpha-1 Antitrypsin Deficiency",
        "hpo": ["HP:0006531 (Emphysema)", "HP:0001404 (Hepatic fibrosis)", "HP:0009060 (Neonatal cholestasis)"],
